...
public class GridRecyclerViewAdapter extends RecyclerView.Adapter<GridRecyclerViewAdapter.ViewHolder> implements View.OnClickListener{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String path0 = Api.HOSTIMG + movieEntityList.get(position * 3).getLocalImg();
        ...
        if(position * 3 + 1 < movieEntityList.size()){
            ...
            String path1 = Api.HOSTIMG + movieEntityList.get(position * 3 + 1).getLocalImg();
        ...
        if(position * 3 + 2 < movieEntityList.size()){
            ...
            String path2 = Api.HOSTIMG + movieEntityList.get(position * 3 + 2).getLocalImg();
